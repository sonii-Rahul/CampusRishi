...
function SideBar(props) {
  ...
  const navigate = useNavigate();
   if (!user) {
    ...
    return <div>Loading...</div>; // Or return null, or render a loading spinner, etc.
  }
      ...
      <div className="flex h-screen flex-col justify-between pt-2 pb-6">
        <div>
          ...
          <ul className="mt-6 space-y-2 tracking-wide">
            ...
            <Link to="/teacher/dashboard" aria-label="dashboard" className="relative flex items-center space-x-4 bg-gradient-to-r from-sky-600 to-black px-4 py-3 text-white">
        ...
        onClick={()=>{props.logingout()}}
          type="button"
          className="rounded-xl bg-black px-3 py-2 text-sm font-semibold text-white shadow-sm hover:bg-black/80 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-black m-2 "
        >
         LogOut
        </button>
